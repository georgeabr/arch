...
pacman -Sy --noconfirm xfce4 xfce4-goodies polkit polkit-gnome sddm mousepad ttf-dejavu ttf-roboto-mono ttf-bitstream-vera ttf-liberation noto-fonts redshift gnupg
